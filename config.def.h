...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_Return, spawn,			SHCMD("neovide") },
	...
	{ 0,                            XF86XK_AudioMute,			spawn, SHCMD("$HOME/.local/src/dwm/scripts/volumeMute.sh; pkill -RTMIN+11 dwmblocks") },
	{ 0,                            XF86XK_AudioLowerVolume,	spawn, SHCMD("$HOME/.local/src/dwm/scripts/volumeDown.sh; pkill -RTMIN+11 dwmblocks") },
	{ 0,                            XF86XK_AudioRaiseVolume,	spawn, SHCMD("$HOME/.local/src/dwm/scripts/volumeUp.sh;   pkill -RTMIN+11 dwmblocks") },
